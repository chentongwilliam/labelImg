...
3. In canvas.py  update function transformPos:
----------------------------------------------

    pyqtSignal() is replaced with Signal()
...
4. In labelImg.py update function loadFile:
-------------------------------------------

    replace self.canvas.setFocus(True) with self.canvas.setFocus()
